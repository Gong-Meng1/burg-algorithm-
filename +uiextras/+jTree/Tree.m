classdef Tree < hgsetget
    ...
    properties (SetAccess=protected, GetAccess=protected)
        ...
        jContainer % Java container (internal)
        ...
        function onNodeDND(tObj,e)
            ...
            if callbacksEnabled(tObj)
                ...
                for idx = 1:numel(TransferData)
                    if TransferData(idx).isa('UIExtrasTree.TreeNode')
                ...
                % Get the operation type: modified from original: move is
                % copy and vv.
