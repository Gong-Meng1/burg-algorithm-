...
%         end
    ...
    function resizegui(varargin)
        ...
        pos = [space,yPos,max(1,width-3*space-listWidth),max(1,height-1.6*yPos)];
...
function str = ecg_InformationList(~,click)
...
function str = std_InformationList(~,click)
% click.x: [n x 1] array, first value is last click
% click.y: [n x 1] array, first value is last click
